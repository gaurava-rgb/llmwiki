...
source_url: "https://x.com/i/status/2034220679671714283/?rw_tt_thread=True"
author: "ℏεsam"
...
![](https://pbs.twimg.com/profile_images/1633697720291704832/GBmxTCa6.jpg)

[Ole Lehmann](<https://twitter.com/itsolelehmann>) [@itsolelehmann](<https://twitter.com/itsolelehmann>)

[ ](<https://twitter.com/itsolelehmann/status/2033919415771713715>)

![How to 10x your Claude Skills \(using Karpathy's autoresearch method\) ](https://pbs.twimg.com/media/HDnj2w9acAEaqWl.jpg)

Your Claude skills probably fail 30% of the time and you don't even notice.

I built a method that auto-improves any skill on autopilot, and in this article I'm going to show you **_exactly_** how to run it yourself.
...
_P.S. If you want more AI workflows like this one delivered to your inbox every week, join 34k readers getting them free:[aisolo.beehiiv.com/subscribe](<http://aisolo.beehiiv.com/subscribe>)_
...
The idea is simple: instead of you manually improving something, you let an AI agent do it for you _in a loop._

![Image](https://pbs.twimg.com/media/HDnlDjwWkAANoH8.jpg)
...
But instead of "rate the writing quality 1-10" (which is vague and different every time), each item on the checklist is a **clear yes or no:**
  ...
  * Did the student include a thesis statement? _Yes or no._
  * Is every source cited? _Yes or no._
  * Is it under 5 pages? _Yes or no._
...
Same idea here. For a landing page copy skill, your checklist might look like:
  ...
  * "Does the headline include a specific number or result?" _(catches vague headlines like "Grow Your Business")_
  * "Is the copy free of buzzwords like 'revolutionary,' 'synergy,' 'cutting-edge,' 'next-level'?"
  * "Does the CTA use a specific verb phrase?" _(catches weak CTAs like "Learn More" or "Click Here")_
  * "Does the first line call out a specific pain point?" _(catches generic openers like "In today's fast-paced world...")_
  * "Is the total copy under 150 words?" _(catches bloated pages that lose the reader)_
...
Here's what the agent actually changed in my skill prompt:
  ...
  * **Added a worked example** of a strong landing page section with the pain point opener and CTA highlighted, so the skill could _see_ what good looks like instead of guessing.
...
_P.S. If you want more AI workflows that help you get more customers, more attention, and more done (without working more hours), I send them to 34k readers every week for free._

_Plus you get a free Claude Cowork masterclass when you join:[aisolo.beehiiv.com/subscribe](<http://aisolo.beehiiv.com/subscribe>)_

[Posted Mar 17, 2026 at 2:52PM](<https://twitter.com/itsolelehmann/status/2033919415771713715>)
