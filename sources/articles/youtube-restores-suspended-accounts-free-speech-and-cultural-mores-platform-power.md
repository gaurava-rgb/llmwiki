...
On [today’s episode of Sharp China](<https://sharpchina.fm/member/episode/a-tik-tok-framework-and-lots-of-questions-nvidia-uncertainty-and-chip-countermeasures-the-prc-propaganda-strategy-on-us-platforms>), Andrew and Bill discuss the latest on an apparent TikTok deal and the continuing saga of Nvidia in China.

On to the Update:

### YouTube Restores Suspended Accounts

From [The Information](<https://www.theinformation.com/briefings/youtube-reallow-accounts-banned-covid-19-election-integrity-violations>):

> YouTube said on Tuesday that it would allow accounts banned for violating its policies on Covid-19 and election integrity to rejoin the platform, following pressure from Republican legislators led by Rep. Jim Jordan. In a letter to Jordan, a lawyer representing YouTube’s parent company Alphabet also said that the Biden Administration had “press[ed] the Company to remove non-violative content” related to the Covid-19 pandemic.
>
> YouTube’s announcement follows changes from Meta Platforms earlier this year softening its fact-checking and hate speech policies. It also comes as YouTube continues to have “productive discussions” with lawyers for Donald Trump regarding Trump’s suit against YouTube for removing his accounts after the January 6 riots, according to an August court filing. A spokesperson for Google declined to comment beyond the letter.

First off, kudos to _The Information_ for their headline: “YouTube to Reallow Accounts Banned Over Covid-19, Election Integrity Violations”; it stands in marked contrast to [other headlines](<https://www.techmeme.com/250923/p25>) that flatly stated that YouTube was reinstating creators “who spread covid misinformation” (quoting [The Verge](<https://www.theverge.com/policy/784238/youtube-covid-election-misinformation-reversal>) in this case) back on the video streaming site. That’s certainly true in some cases, but there is no question that not just legitimate but in retrospect true content was censored, and its creators kicked off the platform. Google, [in that letter to Jordan](<https://judiciary.house.gov/sites/evo-subsites/republicans-judiciary.house.gov/files/evo-media-document/2025-09-23-letter-to-hjc.pdf>), placed the blame squarely on the Biden administration:
...
I am not, as I’m sure you expect at this point, looking to make a partisan point; in fact, this is the perfect week for this news to come out, given the amount of attention that is being paid to political pressure about speech by the current administration. It’s a classic example of the adage that whoever is in power in a democratic system ought to act with restraint, because at some point their opposition will be in power; to say I am concerned about the breakdown of cooperation in game theoretical terms, and the implications of that in the long run, is an understatement.

My concern on Stratechery is more narrow, and that is how tech companies should have approached challenges like these over the past few years, and how I hope they approach them in the future.

### Free Speech and Cultural Mores

Google and YouTube were obviously not the only tech companies under pressure in the COVID era; Meta CEO Mark Zuckerberg [said the same thing a year ago](<https://www.reuters.com/technology/zuckerberg-says-biden-administration-pressured-meta-censor-covid-19-content-2024-08-27/>). Another was Spotify and Joe Rogan, which [I wrote about at the time](<https://stratechery.com/2022/spotify-and-joe-rogan-culture-and-principles-music-versus-podcasts-and-the-long-run/>); I’m going to quote the entire relevant section:
...
>
> I’ve waded into similar weeds myself; back in 2019 I wrote an Article entitled [Tech and Liberty](<https://stratechery.com/2019/tech-and-liberty/>) that made the argument that constraining the definition of free speech to the First Amendment and its limitation on government was to overlook the importance of free speech as a cultural value. I wrote in discussion of Twitter and Facebook’s differing decision about fact-checking politicians:
>
...
>
> I am not here to re-litigate the argument, but rather to make a point that ought to be top of mind for tech executives everywhere: it seems quite clear that the argument is over, and my position lost. Just look at Facebook: “Tech and Liberty” was published in the weeks after CEO Mark Zuckerberg made a speech at Georgetown entitled [Standing for Voice and Free Expression](<https://www.washingtonpost.com/technology/2019/10/17/zuckerberg-standing-voice-free-expression/>); over the ensuing two years Facebook has significantly expanded the definition of what is harmful content (driven both by the pandemic and the aftermath of the 2020 election) and by extension the volume of content that it removes…
>
...
Google, to its credit, affirms this point in their letter, and explicitly admits that it screwed up with Covid in particular:

> YouTube’s mission is to give everyone a voice and show them the world. Every day, YouTube builds and improves tools and systems that empower creators, viewers, and businesses to find and share information. Over two billion logged-in users worldwide visit each month, and over 500 hours of content are uploaded every minute by an extraordinarily diverse community of creators, who span over 100 countries and 80 languages. On a daily basis, users watch over a billion hours of video on YouTube.
>
> There is a wider variety of views on the YouTube platform than on any other information source in history. YouTube will strive to foster self-expression on an array of topics as diverse as its user base, to nurture a thriving creative and informational ecosystem, and to be an engine of economic opportunity…
>
...
I also asked YouTube CEO Neal Mohan about these issues [in last week’s Stratechery Interview](<https://stratechery.com/2025/an-interview-with-youtube-ceo-neal-mohan-about-building-a-stage-for-creators/>), and I think his answer is notable in light of this letter:
...
There is a structural reality to YouTube — and it’s one that applies to the Internet generally — that is quite scary: on one side there are these gargantuan platforms that, [as I argued yesterday](<https://stratechery.com/2025/the-youtube-tip-of-the-google-spear/>), still have massive growth ahead of them; that growth is fueled by individuals enabled by the platform’s scale, and they, as a collective, create an impregnable moat. That means that YouTube’s content choices — not on an individual level, but at that collective level — arguably matter more than government regulations.

This is a weighty responsibility, and there are very reasonable debates to be had about the implications of it; the big lesson of the last decade, however, is that running from that responsibility is the wrong choice. No, platforms shouldn’t have an opinion on everything, but you do need to stand for something, and that something should be free speech. After all, as Mohan noted, that is ultimately the true magic of YouTube, and of the Internet; more importantly, it’s the magic that makes a free society work.
