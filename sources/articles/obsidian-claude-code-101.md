...
source_url: "https://x.com/i/status/2013045749580259680/?rw_tt_thread=True"
author: "Heinrich"
...
a vault is a folder of markdown files that link to each other:
    ...
    ├── [CLAUDE.md](<http://CLAUDE.md/>)           # teaches the ai your system
...
same underlying pattern, different rules. the pattern is:
  ...
  2. a [CLAUDE.md](<http://CLAUDE.md/>) file that teaches the agent your specific system
...
## folder architecture
    ...
    │   ├── [knowledge-work.md](<http://knowledge-work.md/>)    # example topic page
