...
Now that everyone is using ChatGPT, the lazy columnist’s trick of quoting Wikipedia to open an Article is less cliché than it is charming (at least that’s my excuse). Anyhow, [here is Wikipedia’s definition of “steelmanning”](<https://en.wikipedia.org/wiki/Straw_man>):
