...
source_url: "https://twitter.com/elvissun/status/2028671336219107687/?rw_tt_thread=True"
author: "Elvis"
...
![](https://pbs.twimg.com/profile_images/1886389973236011008/7EZHFw9k.jpg)

[Elvis](<https://twitter.com/elvissun>) [@elvissun](<https://twitter.com/elvissun>)

[ ](<https://twitter.com/elvissun/status/2025920521871716562>)
...
![Image](https://pbs.twimg.com/media/HByXnBmW8AANOl9.jpg)
...
![Image](https://pbs.twimg.com/media/HB0NSAEW0AAYPOF.jpg)
...
![Image](https://pbs.twimg.com/media/HB0EN2hXcAAbGi9.png)
...
Each agent gets its own worktree (isolated branch) and tmux session:
    ...
    tmux new-session -d -s "codex-templates" \
      ...
      "$HOME/.codex-agent/[run-agent.sh](<http://run-agent.sh/>) templates gpt-5.3-codex high"
...
But it doesn't poll the agents directly — that would be expensive. Instead, it runs a script that reads the JSON registry and checks:
    ...
    .clawdbot/[check-agents.sh](<http://check-agents.sh/>)
...
The agent commits, pushes, and opens a PR via `gh pr create --fill`. At this point I do _NOT_ get notified — a PR alone isn't done.
...
[Posted Feb 23, 2026 at 1:07PM](<https://twitter.com/elvissun/status/2025920521871716562>)

* * *

while we are on this topic I also moved some crons to sonnet

![Image](https://pbs.twimg.com/media/HCdUHnSa4AAvgzF.png?name=orig)
