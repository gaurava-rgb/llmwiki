...
On [last week’s Sharp China](<https://sharpchina.fm/member/episode/july-politburo-meeting-takeaways-and-trumps-evolving-approach-to-china>), Bill and Andrew discussed the Trump’s administration evolving approach to China, including letting Nvidia sell chips. Meanwhile, Jon at [Asianometry](<https://asianometry.passport.online/>) has a new video about [Visa’s dominance of debit cards](<https://www.youtube.com/watch?v=k2rKS4l6MAk>).

On to the Update:

### ESPN + NFL

From the [Wall Street Journal](<https://www.wsj.com/business/media/the-nfl-is-taking-a-10-stake-in-disneys-espn-158acff5>):

> The National Football League has struck a wide-reaching deal with Disney in which it will take a 10% stake in the ESPN sports empire in return for control of key media assets including NFL Network. Neither Disney nor the NFL would disclose the value of the ESPN stake. Analysts have estimated ESPN’s valuation at between $25 billion and $30 billion, putting the NFL’s piece in the $2.5 billion to $3 billion range. The tie-up, between two of the biggest names in entertainment and sports, furthers the symbiotic relationship between media companies and athletic leagues that is moving beyond just traditional rights deals to televise games…Under the terms of the agreement, ESPN will add NFL Network to its stable of sports channels. It will also distribute the NFL’s Red Zone channel to pay-TV operators, although ownership and digital distribution rights will remain with the league.
>
> For ESPN, the deal strengthens the bond with its most important content provider as it prepares to launch a streaming version of its flagship network later this fall. The addition of more NFL content will likely increase interest in the service. The NFL in turn not only gets a piece of a key Disney asset, but also ensures the future of its two channels which, although popular, will benefit from being part of a media behemoth. The deal will need regulatory approval and, given the power of the NFL and ESPN, might face scrutiny from lawmakers. Assuming the partnership is approved and closed, Disney’s stake in ESPN will drop to 72% from 80% while minority owner Hearst will go to 18% from 20%.

Back in 2023, when Disney was in the middle of separating out ESPN into its own division, fueling speculation that the entertainment company was going to spin the sports network off, [Bob Iger appeared on CNBC for an extended interview](<https://www.cnbc.com/video/2023/07/13/watch-cnbcs-full-interview-with-disney-ceo-bob-iger-on-streaming-wars-and-future-of-media-business.html>) and said he was actually looking for a strategic partner for the business. Here’s the excerpt:
...
[At the time I speculated](<https://stratechery.com/2023/bob-iger-on-cnbc-the-end-of-linear-tv-espn-and-strategic-partnerships-and-apple/>) that Iger was looking to partner with a tech company to help with customer acquisition for the forthcoming ESPN streaming service:
...
You’ll notice that I didn’t even bring up the NFL, not because I didn’t consider them an attractive partner, but rather because that seemed like an outcome that would be too good to be true. In a world of splintering attention and declining ratings the NFL truly stands alone: [72 of the top 100 shows last year were NFL games](<https://www.sportico.com/business/media/2025/nfl-owns-73-of-top-100-broadcasts-election-undermine-sports-tv-dominance-1234822548/>), and that number should be higher this year, given that 12 of the top 100 were related to the Presidential election. Everyone in sports media needs the NFL, so why would the NFL need to partner with ESPN? Just cash their checks.

However, once you dig into the details of this deal, the NFL’s reasoning starts to make a lot of sense.

### NFL Strategy

First off, there are actually two deals, not one. From [ESPN’s press release](<https://espnpressroom.com/us/press-releases/2025/08/espn-to-acquire-nfl-network-and-other-media-assets-from-the-nfl-in-exchange-for-a-10-equity-stake-in-espn/>):
...
One problem the NFL had with the NFL Network is that as strong as the NFL is, it still benefits from being in a bundle; it has always been easier for multichannel video programming distributors (MVPDs) to not include the NFL Network than it has been for them to not include ESPN; this chart is from MoffettNathanson:

![](https://i0.wp.com/stratechery.com/wp-content/uploads/2025/08/espn-nfl-2.png?resize=1330%2C662&ssl=1)

Obviously the overall trend is bad, but it’s notable that the NFL Network’s penetration has stayed at around 73% of ESPN’s; under Disney’s ownership, I would expect these lines to converge as Disney predicates ESPN inclusion in the bundle on NFL Network inclusion as well. That right there is worth a theoretical $367 million/year, assuming [an NFL Network carriage fee of $1.91/month](<https://www.axios.com/pro/media-deals/newsletters/2022/05/10/media-amcs-shopping-spree>); I don’t think that Disney will capture quite that much, but they will definitely make a lot more from the NFL Network than the NFL was able to earn on its own.

At the same time, in order to maintain that carriage fee number, the NFL had to keep the number of games on the NFL Network that undergirded the deals it had with MVPDs; the implication of ESPN back-filling the NFL Network’s 7-game slate with four games from their existing rights deal is that the NFL will now have four additional games it can sell to other distribution partners. That’s also worth a good deal of money.

Ultimately, however, I think the biggest payoff for the NFL isn’t financial: it’s strategic, and very much in-line with how the NFL has thought about its rights historically — and ESPN has always been in the center of that consideration set.

The first phase of the NFL-ESPN relationship was in the 1980s when ESPN first secured rights to the NFL, which was the most important factor in ESPN’s gaining leverage over MVPDs. I wrote in [The Rise and Fall of ESPN’s Leverage](<https://stratechery.com/2023/the-rise-and-fall-of-espns-leverage/>):
...
What was important for the NFL was not only the money and exposure they got from ESPN, but also that they effectively created a competitor for their broadcast network partners, increasing the competition for rights fees, and thus the NFL’s bargaining power.

The second phase of the NFL-ESPN relationship was in the 2000s; this is when cable was at its absolute peak, and other sports leagues — most notably the NBA — moved all of their inventory away from broadcast TV to networks that were willing to pay more. The NFL, however, steadfastly stuck with broadcast TV for the majority of its inventory; in addition, all games on cable and streaming are also simulcast on broadcast TV in a team’s home market. This was, in retrospect, a stroke of genius: by ensuring games remained freely available the NFL both created the conditions for its games to be events, with the largest possible fanbase, and also meant the league was much more insulated from the decline in the cable bundle. And, from a strategic perspective, the NFL maintained the number of plausible bidders for its rights fees.

Now we’re in the third phase, and I think the NFL’s priorities remain the same, but the entities they are worried about are different. Note this quote from Commissioner Roger Goodell in this story from [NBC Sports Pro Football Talk](<https://www.nbcsports.com/nfl/profootballtalk/rumor-mill/news/roger-goodell-sees-apple-and-google-not-nba-and-mlb-as-nfls-competition>):

> Once upon a time, the NFL competed with other American sports. Once upon a time, the NFL competed poorly with other American sports. Now, the NFL doesn’t even view other American sports as competition.
>
...
>
> He’s right, even if the NFL is doing business with Google and could soon be doing business with Apple. The NFL keeps growing. Its influence expands to business beyond football. It’s the one thing that can consistently attract millions to watch an event live, from the significant (like the Super Bowl) to the trivial (like the Hall of Fame game). Even the draft, which could be done via group text, has been shaped into must-see TV and a live event that draws hundreds of thousands to witness, well, not much of anything. Regardless of where the NFL goes from here, it has left other American sports in the dust. And, yes, it is targeting much bigger fish.

I think this is a misinterpretation of Goodell’s quote. Obviously the NFL isn’t going to be a tech company. Indeed, this deal arguably goes the opposite way, as the NFL is giving up a distribution channel, albeit an analog one that has been heavily disrupted by tech. Rather, what the NFL has consistently cared about is its relative power when it comes to bargaining over its rights fees.

On one level, the NFL wants more counterparties, not fewer; that is why the league has created packages for Amazon for Thursday Night Football, Netflix for Christmas Day games, and YouTube for NFL Sunday Ticket (and one regular season football game). If adding ESPN to two broadcast partners in the 1980s was a great idea, then adding a bunch of tech companies in the 2020s is even better!

On the other hand, what the NFL does not want is to be stuck negotiating with anyone but tech companies. The NFL made ESPN in the 1980s, and today, more than ever, the NFL can make-or-break all of its traditional partners, whether it be ESPN, CBS, NBC, Fox, or ESPN/ABC. The NFL, however, can not make or break Amazon or Google or Netflix or Apple. To that end, I think it is very much in the NFL’s interest to make sure there is at least one very strong alternative to the tech companies through which to distribute its games. That, more than anything, is what I think underlies this investment: the NFL is competing with the tech companies for negotiating leverage, and solidifying ESPN as a long-term alternative to Big Tech distribution is very much in the NFL’s interest.

This is, meanwhile, obviously a huge win for Disney; Iger said on [the company’s earnings call](<https://seekingalpha.com/article/4809484-the-walt-disney-company-dis-q3-2025-earnings-call-transcript>):

> Let me start with the fact that the result of these agreements will give ESPN more games, more NFL games than they’ve ever had before. Basically, there will be 28 windows for NFL games, which is an increase over what we’ve had before. Previously, there were 22. That obviously is of major significance in terms of both ESPN, but also in terms of the audience. We’re basically giving ESPN NFL fans more opportunities to watch NFL games than they’ve ever had before.
>
> Because of the acquisition of the NFL Network, not only will we continue to distribute it from a linear perspective, but it will be fully essentially included in or ingested within the ESPN direct-to-consumer app. So those games, the 7 games that are on the NFL Network will all be part of ESPN’s direct-to-consumer offering. I think that’s obviously where the major value will come. But in addition to that, there is a number of other elements, we’re calling features and functionality that will improve the quality of the experience and actually grow the quality of experience of the fan on the ESPN app. And that includes smooth integration with fantasy, with betting and a combination of our fantasy businesses, by the way, with stats, with the ability to basically personalize sports center with NFL highlights, I could go on and on a commerce opportunity off of the ESPN app to buy NFL merchandise.
>
...
There is basically no downside for Disney here, which I think really makes my overall point about the NFL’s motivation. To use a tech analogy, some of the most outsized outcomes for startups come when they are acquired for strategic reasons; the acquiring company is not paying for revenues or profits, but rather for more esoteric reasons that matter to their longterm strategic positioning. In this case Disney is getting nothing but upside in exchange for giving equity to a partner who is single-handedly responsible for that equity being valuable in the first place, not because the NFL necessarily needs a financial reward, but because they are worried about much larger fish in the distribution pond.

### Additional Disney Notes

There was a whole host of other Disney news this week, both in terms of standalone announcements and on the company’s earnings call. Three items of note:

**WWE Deal**

In addition to three more NFL games, Disney also made a deal with the WWE. From the [Wall Street Journal](<https://www.wsj.com/business/media/disney-paying-1-6-billion-for-wwe-rights-a069f4cc>):

> Disney’s ESPN and TKO Group’s World Wrestling Entertainment have reached a more than $1.6 billion agreement that will give the sports-media company exclusive rights to many of WWE’s most high profile events. The five-year deal, which will begin in 2026, includes the U.S. streaming rights to major events including WrestleMania and SummerSlam. ESPN will pay $325 million a year for the rights, according to people familiar with the matter. That is a significant increase from the WWE’s current five-year deal with Peacock, which was valued at $900 million, according to people familiar with the pact.
>
> The new agreement with ESPN follows a 10-year deal the WWE struck with Netflix last year for its weekly show “Raw” valued at more than $5 billion. “Raw” has become a solid performer for the streamer. The events will be available on ESPN’s new streaming service, which is slated to debut this fall at a price tag of $29.99 a month. Under the deal, select coverage will be simulcast on ESPN’s cable channels.

The WWE has a long-running track record of driving customer acquisition, starting with pay-per-view, then as a standalone streaming service, then for Peacock. That’s what I think was attractive to ESPN, particularly as they get their streaming service off of the ground.

**One App to Rule Them All**

From Iger’s prepared remarks:
...
Disney will never regain what they had in terms of bundling and churn mitigation with the linear TV bundle, but at least they now know what they lost!

**A Sports Aggregator?**

From the question-and-answer portion of the call:
...
>
> **Bob Iger:** Yes. We believe there may be opportunities for us to bundle other company sports offerings. We’ve actually had some discussions with some other companies on doing just that. Nothing to report on that. But, obviously, we’re not only interested in growing engagement and growing our own subs, but we’re interested in serving consumers better as well. And the more sports can be offered in one destination for the consumer, if we can improve the ease of use for consumers, ease of finding things because as a devoted sports fan, I often have to work to try to find what platform sports are on. If we can help consumers in that regard, we’re certainly going to try.

Actually, maybe I was wrong in the last item: Disney not only knows what they lost with the linear TV bundle, but they would very much like to recreate the bundling and churn mitigation benefits that came from everyone’s content being delivered through the same pipe, this time by building [a sports aggregator](<https://stratechery.com/2023/an-espn-aggregator-google-magic-eraser-bing-chat-monetization/>). I’m not sure it’s going to work — Disney is dealing with the same companies that were cheating on the cable bundle in the first place, confident that ESPN was single-handedly preserving its viability — but if anyone can build the new bundle it’s the company that ruled the last one.
